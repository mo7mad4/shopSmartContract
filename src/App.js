 ...
 useEffect(()=>{
  productsCount&&loadProducts()
      ...
      const buyProduct = (id,price)=>{
        contract.methods.purchasedShopProduct(id).send({from:account,gasPrice:price.toString(16),gas : price.toString(16)});
      }
...
<div className="card m-3">
  ...
  <div className="card-body">
    <blockquote className="blockquote mb-0">
      ...
      <footer className="blockquote-footer">By Mohammed - Abod </footer>
    </blockquote>
  </div>
</div>
